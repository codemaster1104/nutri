...
TOOL_INSTRUCTIONS = (
    ...
    " — CRITICAL: You must calculate and estimate realistic calories, protein, carbs, and fat "
    " based on the food description if they are not explicitly specified by the user. "
    " Never pass 0 or leave them blank unless the food is literally zero calories (e.g. water);"
    " log_activity(description, calories_burned, duration, unit) "
    " — CRITICAL: Estimate a realistic calories_burned and duration if not specified by the user;"
